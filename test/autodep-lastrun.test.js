...
describe('Testing GulpTask', function () {
  ...
  it(`Tdd task depending implicitly on another - lastRun`, testGulpProcess({
    ...
    messages: [
      `Task 'copy' (SRC): 2 items`, // Same with 'newer'
      `Task 'copy' (NWR): 2 items`, // Same
      `Task 'transpile' (SRC): 2 items`, // Same
      `Task 'transpile' (NWR): 2 items`, // Same
      `Task 'transpile' (DST): 2 items`, // Same
      [`Finished 'default' after`,
        snapshot(refFiles),
        touchFile('tmp/src/gulptask.js')],
      `Task 'transpile' (SRC): 1 item`, // Would have been (SRC): 2 items
      ...
      `Task 'copy' (SRC): 1 item`, // Would have been (SRC): 2 items
