...
var _index = require('./properties/index');
...
var SimpleGulpTask = exports.SimpleGulpTask = function () {
  function SimpleGulpTask() {
    ...
    (0, _index.setConfigProperties)(this, args);
    (0, _index.setMainProperties)(this, args);
    (0, _index.setStreamerProperties)(this, args);
    (0, _index.setFunctionProperties)(this, args);
...
['literal', { type: 'ignore', rest: true }], {
  preprocess: function preprocess(args) {
    return [(0, _index.getName)(args)].concat((0, _toConsumableArray3.default)(args));
  }
});
