...
var returnsBool = function returnsBool(fn) {
  return function (args) {
    return !!fn(args);
  };
};

var getDebug = returnsBool(getter('debug'));
var getDebugDest = returnsBool(getter('debugDest'));
var getDebugMinimal = getter('debugMinimal');
var getDebugNewer = returnsBool(getter('debugNewer'));
var getDebugSrc = returnsBool(getter('debugSrc'));
